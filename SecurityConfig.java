...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
            .authorizeRequests()
                // PUBLIC ENDPOINTS - Add root URL and health check
                .antMatchers("/", "/health", "/**/*.html", "/**/*.css", "/**/*.js").permitAll() 
                .antMatchers("/api/auth/**").permitAll()
                .antMatchers("/api/jobPost/**").permitAll()
                .antMatchers("/api/jobposts/**").permitAll()  // Added for job posts
                .antMatchers("/api/jobSeekers/**").permitAll()
