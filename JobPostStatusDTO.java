...
public class JobPostStatusDTO {
    ...
    public JobPostStatusDTO(int totalJobs, int totalInternships, int totalFullTimeJobs,
                            int totalPartTimeJobs, int totalContractualJobs, int totalFreelanceJobs) {
    ...
    public void setTotalFullTimeJobs(int totalFullTimeJobs) { this.totalFullTimeJobs = totalFullTimeJobs; }
    public int getTotalPartTimeJobs() { return totalPartTimeJobs; }
    public void setTotalPartTimeJobs(int totalPartTimeJobs) { this.totalPartTimeJobs = totalPartTimeJobs; }
    public int getTotalContractualJobs() { return totalContractualJobs; }
    public void setTotalContractualJobs(int totalContractualJobs) { this.totalContractualJobs = totalContractualJobs; }
    public int getTotalFreelanceJobs() { return totalFreelanceJobs; }
    public void setTotalFreelanceJobs(int totalFreelanceJobs) { this.totalFreelanceJobs = totalFreelanceJobs; }
}